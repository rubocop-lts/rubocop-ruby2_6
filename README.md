...
| [`rubocop-ruby2_6`][⛳️ini-gh] | [![Gem Version][⛳️ini-vi]][⛳️ini-g] | [![Total DL][🖇️ini-dti]][⛳️ini-g] [![DL Rank][🏘️ini-rti]][⛳️ini-g] | [![Current][🚎ini-cwfi]][🚎ini-cwf] [![Heads][🖐ini-hwfi]][🖐ini-hwf] | [![Open Issues][📗ini-ioi]][📗ini-io] [![Closed Issues][🚀ini-ici]][🚀ini-ic] [![Open PRs][💄ini-poi]][💄ini-po] [![Closed PRs][👽ini-pci]][👽ini-pc] |
...
[⛳️ini-vi]: http://img.shields.io/gem/v/rubocop-ruby2_6.svg
[🖇️ini-dti]: https://img.shields.io/gem/dt/rubocop-ruby2_6.svg
[🏘️ini-rti]: https://img.shields.io/gem/rt/rubocop-ruby2_6.svg
[🚎ini-cwf]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/current.yml
[🚎ini-cwfi]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/current.yml/badge.svg
[🖐ini-hwf]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/heads.yml
[🖐ini-hwfi]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/heads.yml/badge.svg
[🧮ini-lwf]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/legacy.yml
[🧮ini-lwfi]: https://github.com/rubocop-lts/rubocop-ruby2_6/actions/workflows/legacy.yml/badge.svg
[📗ini-io]: https://github.com/rubocop-lts/rubocop-ruby2_6/issues
[📗ini-ioi]: https://img.shields.io/github/issues-raw/rubocop-lts/rubocop-ruby2_6
[🚀ini-ic]: https://github.com/rubocop-lts/rubocop-ruby2_6/issues?q=is%3Aissue+is%3Aclosed
[🚀ini-ici]: https://img.shields.io/github/issues-closed-raw/rubocop-lts/rubocop-ruby2_6
[💄ini-po]: https://github.com/rubocop-lts/rubocop-ruby2_6/pulls
[💄ini-poi]: https://img.shields.io/github/issues-pr/rubocop-lts/rubocop-ruby2_6
[👽ini-pc]: https://github.com/rubocop-lts/rubocop-ruby2_6/pulls?q=is%3Apr+is%3Aclosed
[👽ini-pci]: https://img.shields.io/github/issues-pr-closed/rubocop-lts/rubocop-ruby2_6
[⛳️ini-g]: https://rubygems.org/gems/rubocop-ruby2_6
[⛳️ini-gh]: https://github.com/rubocop-lts/rubocop-ruby2_6
...
This gem, via [standard (Standard Ruby)][standardrb], allows RuboCop to analyze Ruby 2.6 code,
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/ruby_rspec.yml
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/ruby.yml
```
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/rails_rspec.yml
```
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/rails.yml
```
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/rubygem_rspec.yml
```
...
```yaml
inherit_gem:
  rubocop-ruby2_6: rubocop-lts/rubygem.yml
```
